...
md`# RAMPVIS Idiom : Integrated Algorithmic Tools for Visual Analytics`
)});
...
FileAttachment("tool (2).png").image()
)});
  main.variable(observer()).define(["md"], function(md){return(
...
`
  ...
  main.variable(observer()).define(["md"], function(md){return(
md`Hui, Alma, Cagatay, Franck, Rita, Shaunave
`
)});
  main.variable(observer()).define(["md"], function(md){return(
md`---
...
## 8. REFERENCES`
  ...
  main.variable(observer()).define(["md"], function(md){return(
md`[1] Tam, Kwok-Leung, Fang, H., Aubrey, Andrew, Grant, P. W., Rosin, Paul L., Marshall, Daniel and Chen, M. (2011). Visualization of time-series data in parameter space for understanding facial dynamics. Computer Graphics Forum 30 (3), pp. 901-910. 10.1111/j.1467-8659.2011.01939.x

[2] T. Spinner, U. Schlegel, H. Schäfer and M. El-Assady, "explAIner: A Visual Analytics Framework for Interactive and Explainable Machine Learning," in IEEE Transactions on Visualization and Computer Graphics, vol. 26, no. 1, pp. 1064-1074, Jan. 2020, doi: 10.1109/TVCG.2019.2934629.

[3] G. K. L. Tam, V. Kothari and M. Chen, (2017). "An Analysis of Machine- and Human-Analytics in Classification," in IEEE Transactions on Visualization and Computer Graphics, vol. 23, no. 1, pp. 71-80, Jan. 2017, doi: 10.1109/TVCG.2016.2598829.

[4] Slingsby, A. , Hyde, J. and Turkay, C.  (2019). Visual Analysis of Reactionary Train Delay from an Agent-Based Model. Poster presented at the EuroVis 2019, 3-7 Jun 2019, Porto, Portugal.

[5] Covid-19 EERA model (2021). https://scottishcovidresponse.github.io/Covid19_EERAModel/site/model_documentation.html.

[6] Wenskovitch, John, et al. "Towards a systematic combination of dimension reduction and clustering in visual analytics." IEEE transactions on visualization and computer graphics 24.1 (2017): 131-141.

[7] Packer, Eli, et al. "Visual analytics for spatial clustering: Using a heuristic approach for guided exploration." IEEE Transactions on Visualization and Computer Graphics 19.12 (2013): 2179-2188.

[8] Ali, Mohammed, et al. "Clustering and classification for time series data in visual analytics: A survey." IEEE Access 7 (2019): 181314-181338.

[9] Gibson, F., Fabbro, R., Rahat, A., Torsney-Weir, T., Archambault, D., Gravenor, M. and Lucini, B., 2021, July. An interactive tool for enhancing hospital capacity predictions using an epidemiological model. In Proceedings of the Genetic and Evolutionary Computation Conference Companion (pp. 55-56).`
)});
